...
void vTarefaEmissora(void *){
  ...
  uint32_t inicio = 0, fim = 0, taskNotification = 0xff;    float mediaTempo = 0.0;
  ...
  do{
    ...
    xTaskNotify(xTaskReceptora, taskNotification, eSetBits);
...
void vTarefaReceptora(void *){
  ...
  do{
    ...
    xTaskNotifyWait(0, 0xffffffff, &taskNotification, portMAX_DELAY);
    xTaskNotify(xTaskEmissora, taskNotification, eSetBits);
  }while(1);
}
