...
void vTarefaEmissora(void *){
  ...
  do{
    ...
    xEventGroupSetBits(xEventGroup1, BITS);
    xEventGroupWaitBits(xEventGroup2, BITS, pdTRUE, pdTRUE, portMAX_DELAY);
  }while(i--);
...
void vTarefaReceptora(void *){
  do{
    ...
    xEventGroupWaitBits(xEventGroup1, BITS, pdTRUE, pdTRUE, portMAX_DELAY);
    xEventGroupSetBits(xEventGroup2, BITS);
  }while(1);
}
