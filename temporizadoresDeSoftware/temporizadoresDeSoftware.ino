...
void setup(){
  ...
  TEMPO_TICKS = 23;  //Variável que altera o tempo, em ticks, do temporizador
...
void FuncaoRetorno(TimerHandle_t xTimer){
  ...
  i++;
  if(i >= 51){
    xTimerStop(xTimer, portMAX_DELAY);  //Para o temporizador
    i = 0;
    ...
    xTimerChangePeriod(xTimer, TEMPO_TICKS, TEMPO_TICKS);
  }
